---
description: >-
  Create a BSC LP burn token with one click. Transaction taxes automatically
  burn liquidity pool tokens, helping build a deflationary token economy.
---

# BSC - Reserve Burn Token Creator Tutorial
...
## What is CiaoTool BSC Reserve Burn Token Creator?

<figure><picture><source srcset="../../../.gitbook/assets/屏幕截图 2026-06-16 182459.png" media="(prefers-color-scheme: dark)"><img src="../../../.gitbook/assets/image (962).png" alt="CiaoTool BSC Toolkit Page about BSC Reserve Burn Token Creator Feature"></picture><figcaption></figcaption></figure>

**CiaoTool BSC Reserve Burn Token Creator** offers no-code deployment for hyper-deflationary assets, empowering founders to instantly launch BEP-20 tokens embedded with an automated LP burn mechanism.

Unlike standard assets, this contract features automated routing to execute scheduled, quantitative token burns directly within the liquidity pool. As pool token supply chokes continuously, the shifting asset ratio algorithmically and permanently raises the token’s price floor.

| Dimension           | Standard Token                                       | Reserve Burn Token                                         |
| ------------------- | ---------------------------------------------------- | ---------------------------------------------------------- |
| Total Supply        | Fixed and constant                                   | Continually deflationary; shrinks with trading volume      |
| Pricing Mechanism   | Driven entirely by standard market supply/demand     | Built-in price floor support; implicitly deepens liquidity |
| Investor Psychology | Ideal for basic utility circulation & store of value | Drives intense FOMO; strongly rewards long-term holding    |

Start your Reserve Burn Token Creator on BNB Smart Chain with CiaoTool now:

{% embed url="https://bsc.ciaotool.io/en/token/lp-burn" %}

***

## Why Choose CiaoTool BSC Reserve Burn Token Creator?

CiaoTool delivers a professional asset issuance solution on the BNB Chain that perfectly balances absolute security with streamlined operations, establishing a highly efficient and robust deployment standard:

* **Auto Engine**\
  Eliminates manual execution; the contract autonomously runs periodic pool burns to secure a price floor moat.
* **Flexible Taxes**\
  Customizable buy/sell taxes with flexible options for pool backflow, marketing cut, or burn to suit any strategy.
* **No-Code**\
...
* **Burn Period (Hours):** Defines the frequency of each automated pool burn. Supports a configurable range from 1 to 48 hours.
* **Burn Percentage:** Specifies the percentage of pool tokens to be destroyed in a single burn event. Supports a range from 0.01% to 1% (with a strict maximum daily burn cap of 24%).
{% endstep %}
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td>Create Liquidity Pool - V2</td><td><a href="../../../chains/bsc/swap/create-liquidity/v2.md">v2.md</a></td></tr><tr><td><a data-footnote-ref href="#user-content-fn-1">Liquidity Bundler</a> - V2</td><td><a href="../../../chains/bsc/swap/liquidity-bundler/v2.md">v2.md</a></td></tr><tr><td>Create Liquidity Pool - V3</td><td><a href="../../../chains/bsc/swap/create-liquidity/v3.md">v3.md</a></td></tr><tr><td><a data-footnote-ref href="#user-content-fn-1">Liquidity Bundler</a> - V3</td><td><a href="../../../chains/bsc/swap/liquidity-bundler/v3.md">v3.md</a></td></tr></tbody></table>
{% endstep %}
{% endstepper %}
...
<summary><strong>Why are tokens not being burned as expected?</strong></summary>

1. Preset burn interval not reached.
2. Requires non-whitelisted market sell orders to execute the burn.
