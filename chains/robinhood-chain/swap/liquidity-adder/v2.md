...
<figure><img src="../../../../.gitbook/assets/image (707).png" alt="CiaoTool Robinhood链 添加 V2 流动性 页面"><figcaption></figcaption></figure>
...
立即在 Robinhood Chain 上，用 CiaoTool​ 添加 V2 流动性池操作：

{% embed url="https://r.ciaotool.io/zh-Hans/swap/v2/add-liquidity-v2" %}
