...
<figure><img src="../../../../.gitbook/assets/image (708).png" alt="CiaoTool Robinhood链 添加 V3 流动性页面"><figcaption></figcaption></figure>
...
立即在 Robinhood Chain 上，用 CiaoTool​ 添加 V3 流动性池：

{% embed url="https://r.ciaotool.io/zh-Hans/swap/v3/add-liquidity-v3" %}
