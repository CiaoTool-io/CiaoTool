...
<figure><img src="../../../../.gitbook/assets/image (705).png" alt="CiaoTool Robinhood链 创建 V2 流动性资金池 页面"><figcaption></figcaption></figure>
...
立即在 Robinhood Chain 上，用 CiaoTool​ 创建 V2 流动性池功能开启代币交易操作：

{% embed url="https://r.ciaotool.io/zh-Hans/swap/v2/create-liquidity-v2" %}
