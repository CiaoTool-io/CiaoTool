...
If you want to create a V2 liquidity pool featuring ease of use and full-range coverage, please refer to the [**Create V2 Liquidity Pool and Buy**](../create-and-buy/v2.md) guide.
{% endhint %}
