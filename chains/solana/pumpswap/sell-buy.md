---
description: >-
  An asset migration tool for PumpSwap that combines sells and multi-wallet buys
  within the same block. Creates natural trading activity, reducing MEV risk and
  optimizing on-chain asset distribution.
---

# PumpSwap - Sell & Bundled Buy Tutorial

{% hint style="info" %}
**CiaoTool PumpSwap Sell & Bundled Buy** now fully supports all quote tokens, including official **SOL and USDC**. Please switch to the specific pool function page first to perform bundled operations.
{% endhint %}

## What is CiaoTool PumpSwap Sell & Bundled Buy?

<figure><img src="../../../.gitbook/assets/image (870).png" alt="CiaoTool Solana Toolkit Page about PumpSwap Sell and Bundled Buy Feature"><figcaption></figcaption></figure>

**CiaoTool PumpSwap Sell & Bundled Buy** is an advanced tool focusing on transaction continuity and on-chain liquidity management. Utilizing underlying smart aggregation technology, it allows you to automatically enable a designated wallet to complete token sell operations on **PumpSwap** within the exact same block, while synchronously triggering the batch buy actions of multiple independent wallets.
...
## **Step by Step |** PumpSwap Sell & Bundled Buy
...
There is no limit on the number of imported wallets for **PumpSwap Sell & Bundled Buy**, but each transaction group supports a maximum of **20 addresses** for bundled buying.
...
<summary><strong>What Is the PumpSwap Sell &#x26; Bundle Buy Feature?</strong></summary>

Sell & Bundle Buy is an advanced asset migration tool built for PumpSwap. It allows a designated wallet to sell tokens while multiple wallets simultaneously execute buy orders within the same block. Using block-level transaction coordination, assets can be redistributed across wallets through real market trades.
