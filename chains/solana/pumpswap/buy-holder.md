---
description: >-
  An automated new-wallet buying tool for PumpSwap. Creates wallets and executes
  real purchases automatically. Helps increase holder count and improve token
  distribution.
---

# PumpSwap - Boost Holders Tutorial
...
## What is CiaoTool PumpSwap Boost Holders?

<figure><img src="../../../.gitbook/assets/image (838).png" alt="CiaoTool Solana Toolkit Page about PumpSwap Boost Holders Feature"><figcaption></figcaption></figure>

**CiaoTool PumpSwap Boost Holders** is an on-chain data and asset distribution optimization tool custom-built for the **PumpSwap platform** within the Solana ecosystem. It allows users to automatically generate brand-new wallet addresses in batches through configured parameters and control these addresses to independently execute token buy operations on the order book.
...
Start your Boost Holders on PumpSwap with CiaoTool now:

{% embed url="https://ciaotool.io/en-US/pumpSwap/bundled-buy" %}

***

## Why Choose CiaoTool PumpSwap Boost Holders?

CiaoTool provides a professional solution for optimizing holder data on the PumpSwap platform, balancing authenticity with high execution efficiency. For users who need to perfect early chip distribution or steadily enhance the project's data health, this tool builds a robust automated defense:
...
## **Step by Step |** PumpSwap Boost Holders
...
<summary><strong>What is the PumpSwap Boost Holders feature?</strong></summary>
