---
description: Solana 一键增发代币，CiaoTool 代币增发工具让您根据市场需求灵活调整供应，优化代币管理，帮助项目成长。
---

# Solana - 代币增发教程

{% hint style="success" %}
**Solana 代币增发：**[https://ciaotool.io/zh-CN/token/mint](https://ciaotool.io/zh-CN/token/mint)
{% endhint %}
