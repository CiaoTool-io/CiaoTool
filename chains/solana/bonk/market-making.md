...
# Bonk - Market Making Guide

{% hint style="info" %}
**CiaoTool Bonk Market Making** now fully supports all quote tokens, including official **SOL and USD1**.
{% endhint %}

## Overview

**CiaoTool Bonk Market Making** is an automated market-making and liquidity management tool for Bonk.fun. Users can customize trade amounts, execution frequency, wallet count, and buy/sell strategies, while the system coordinates multiple wallets to execute trades continuously, increase market activity, and optimize overall data performance.
...
{% embed url="https://ciaotool.io/en/bonk/market-making" %}
