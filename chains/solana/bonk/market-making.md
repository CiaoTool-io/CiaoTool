---
description: >-
  An automated market-making and trading tool built for Bonk.fun. Increasing
...
# Bonk - Market Making Tutorial

{% hint style="info" %}
**CiaoTool Bonk Market Making** now fully supports all quote tokens, including official **SOL and USD1**. Please switch to the specific token page first to perform market management operations, meeting your rapid market-making service needs across various scenarios.
{% endhint %}

## What is CiaoTool Bonk Market Making?

<figure><img src="../../../.gitbook/assets/image (796).png" alt="CiaoTool Solana Toolkit Page about Bonk.fun Market Making Feature"><figcaption></figcaption></figure>

**CiaoTool Bonk Market Marking** is an advanced automated market-making and liquidity optimization tool custom-built for the Solana ecosystem. It allows project teams and professional groups to fully automate the execution of advanced market-making strategies on **Bonk.fun** by customizing trading parameters, thereby safely and robustly managing token order book depth and market activity.
...
## Why Choose CiaoTool Bonk Market Making?
...
## **Step by Step |** Bonk Market Making
...
There are no quantity limits on importing wallets for **Bonk Market Making**. Transaction fees are paid independently by each wallet.
{% endhint %}
