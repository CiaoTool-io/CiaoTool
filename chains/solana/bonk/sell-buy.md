...
# Bonk - Sell & Bundled Buy Tutorial
...
## What is CiaoTool Bonk Sell & Bundled Buy?

<figure><img src="../../../.gitbook/assets/image (871).png" alt="CiaoTool Solana Toolkit Page about Bonk.fun Sell and Bundled Buy Feature"><figcaption></figcaption></figure>

**CiaoTool Bonk Sell & Bundled Buy** is an advanced tool focusing on transaction continuity and on-chain liquidity management. Utilizing underlying smart aggregation technology, it allows you to automatically enable a designated wallet to complete token sell operations on **Bonk.fun** within the exact same block, while synchronously triggering the batch buy actions of multiple independent wallets.
...
## **Step by Step |** Bonk Sell & Bundled Buy
...
There is no limit on the number of imported wallets for **Bonk Sell & Bundled Buy**, but each transaction group supports a maximum of **20 addresses** for bundled buying.
