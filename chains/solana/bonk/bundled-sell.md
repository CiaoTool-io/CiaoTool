...
<figure><picture><source srcset="../../../.gitbook/assets/屏幕截图 2026-09-09 151154.png" media="(prefers-color-scheme: dark)"><img src="../../../.gitbook/assets/image (920).png" alt="CiaoTool Solana Chain Bonk 多地址捆绑卖出页面"></picture><figcaption></figcaption></figure>

**CiaoTool Bonk 多地址捆绑卖出**是一款专注于交易执行优化与链上流动性管理的高阶工具。它允许您通过底层智能聚合技术，在同一个区块内，自动让多个独立钱包同步完成 Bonk.fun 上的代币批量卖出操作。&#x20;
