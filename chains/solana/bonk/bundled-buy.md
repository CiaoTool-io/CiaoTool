---
description: >-
  Custom-built for Bonk.fun, this tool executes multi-wallet purchases within a
  single block, securely optimizing holder distribution and boosting asset
  allocation efficiency.
---

# Bonk - Multi-Address Bundled Buy Tutorial

{% hint style="info" %}
**CiaoTool Bonk Multi-Address Bundled Buy** now fully supports all quote tokens, including official **SOL and USD1**. Please switch to the specific pool function page first to perform bundled operations.
{% endhint %}

## What is CiaoTool Bonk Multi-Address Bundled Buy?

<figure><img src="../../../.gitbook/assets/image (852).png" alt="CiaoTool Solana Toolkit Page about Bonk.fun Multi-address Bundled Buy Feature"><figcaption></figcaption></figure>

**CiaoTool Bonk Multi-address Bundled Buy** is an advanced tool for trade execution optimization and on-chain liquidity management. Utilizing smart aggregation technology, it enables multiple independent wallets to synchronously execute batch token purchases on **Bonk.fun** within the exact same block.
...
## Why Choose CiaoTool Bonk Multi-Address Bundled Buy?
...
## **Step by Step |** Bonk Multi-address Bundled Buy
...
There is no limit on the number of imported wallets for **Bonk Multi-address Bundled Buy**, but each transaction group supports a maximum of **10 addresses** for bundled buying.
...
* JITO Anti-Sandwich Mode: 100% immune to sandwich attacks and front-running. Packaged in the same block for precise, identical-price execution. Perfect for large buys and token snipes. (Max 9 wallets/group)
* RPC Standard Mode: Maximum concurrency with zero Jito tips. Executes via standard nodes, but carries risks of MEV sandwich attacks. (Max 10 wallets/group)
{% endstep %}
...
<summary><strong>What is the Bonk Multi-address Bundled Buy feature?</strong></summary>
