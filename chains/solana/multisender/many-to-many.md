---
description: 批量将多个钱包中的 SOL 或代币转入对应接收地址，支持灵活金额设置、固定或随机发送间隔，以及 RPC 和 Jito 发送方式，让多钱包资产调拨更加便捷。
---
...
CiaoTool Solana 多对多转账是一款免代码批量转账工具，支持从多个发送钱包向各自对应的接收地址发送 SOL 或受支持的 SPL 代币。
