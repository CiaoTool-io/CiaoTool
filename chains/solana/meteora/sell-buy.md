---
description: >-
  An asset migration tool for Meteora that combines sells and multi-wallet buys
  within the same block. Creates natural trading activity, reducing MEV risk and
  optimizing on-chain asset distribution.
---

# Meteora - Sell & Bundled Buy Tutorial

## What is CiaoTool Meteora Sell & Bundled Buy?

<figure><img src="../../../.gitbook/assets/image (872).png" alt="CiaoTool Solana Toolkit Page about Meteora Sell and Bundled Buy Feature"><figcaption></figcaption></figure>

**CiaoTool Meteora Sell & Bundled Buy** is an advanced tool focusing on transaction continuity and on-chain liquidity management. Utilizing underlying smart aggregation technology, it allows you to automatically enable a designated wallet to complete token sell operations on **Meteora** within the exact same block, while synchronously triggering the batch buy actions of multiple independent wallets.
...
## **Step by Step |** Meteora Sell & Bundled Buy
...
There is no limit on the number of imported wallets for **Meteora Sell & Bundled Buy**, but each transaction group supports a maximum of **20 addresses** for bundled buying.
...
<summary><strong>What Is the Meteora Sell &#x26; Bundle Buy Feature?</strong></summary>

Sell & Bundle Buy is an advanced asset migration tool built for Meteora. It allows a designated wallet to sell tokens while multiple wallets simultaneously execute buy orders within the same block. Using block-level transaction coordination, assets can be redistributed across wallets through real market trades.
