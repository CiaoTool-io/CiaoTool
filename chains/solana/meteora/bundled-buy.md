---
description: >-
  Custom-built for Meteora, this tool executes multi-wallet purchases within a
  single block, securely optimizing holder distribution and boosting asset
  allocation efficiency.
---

# Meteora - Multi-Address Bundled Buy Tutorial

## What is CiaoTool Bonk Multi-Address Bundled Buy?

<figure><img src="../../../.gitbook/assets/image (853).png" alt="CiaoTool Solana Toolkit Page about Meteora Multi-address Bundled Buy Feature"><figcaption></figcaption></figure>

**CiaoTool Meteora Multi-address Bundled Buy** is an advanced tool for trade execution optimization and on-chain liquidity management. Utilizing smart aggregation technology, it enables multiple independent wallets to synchronously execute batch token purchases on **Meteora** within the exact same block.
...
## Why Choose CiaoTool Meteora Multi-Address Bundled Buy?
...
## **Step by Step |** Meteora Multi-address Bundled Buy
...
There is no limit on the number of imported wallets for **Meteora Multi-address Bundled Buy**, but each transaction group supports a maximum of **20 addresses** for bundled buying.
...
<summary><strong>What is the Meteora Multi-address Bundled Buy feature?</strong></summary>
