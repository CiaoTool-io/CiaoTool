...
# Meteora - Multi-Address Bundled Buy Guide

{% hint style="info" %}
**CiaoTool Meteora Multi-address Bundled Buy** now fully supports all liquidity pool types, including **DBC, DLMM, and DAMM V2**.
{% endhint %}

## Overview

CiaoTool Meteora Multi-Wallet Bundle Buy is a multi-wallet trading tool. Users can configure multiple wallets and purchase amounts, while the system automatically builds the transactions and submits them in a Bundle according to the preset order.
...
{% embed url="https://ciaotool.io/en/meteora/multi-address-buy" %}
