...
# Meteora - Boost Makers Guide

{% hint style="info" %}
**CiaoTool Meteora Boost Makers** now fully supports all liquidity pool types, including **DBC, DLMM, and DAMM V2**.
{% endhint %}

## Overview

**CiaoTool Meteora Boost Makers** is a multi-address automated trading tool. It generates new wallets in batches and uses them to purchase a specified token.
...
{% embed url="https://ciaotool.io/en/meteora/newaddr-buyers-markers" %}
