...
# Meteora - Batch Swap Guide

{% hint style="info" %}
**CiaoTool Meteora Batch Swap** now fully supports all liquidity pool types, including **DBC, DLMM, and DAMM V2**.
{% endhint %}

## Overview

**CiaoTool Meteora Batch Trading** is a multi-wallet automated trading tool. Users can import or select multiple wallets, configure the trade direction and amount for each wallet, and execute token purchases or sales in one batch.
...
{% embed url="https://ciaotool.io/en/meteora/batch-swap" %}
