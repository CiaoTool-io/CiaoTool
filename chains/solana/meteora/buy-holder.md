...
# Meteora - Boost Holders Guide

{% hint style="info" %}
**CiaoTool Meteora Boost Holders** now fully supports all liquidity pool types, including **DBC, DLMM, and DAMM V2**.
{% endhint %}

## Overview

**CiaoTool Meteora Holder Booster** is a multi-address token distribution tool. It generates new wallets in batches, distributes trading funds, and uses each wallet to purchase the selected token. The purchased tokens remain in their respective wallets, creating active token-holding accounts.
