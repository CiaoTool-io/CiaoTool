...
{% hint style="info" %}
**CiaoTool PumpFun 创建并买入**现已全面支持官方 **SOL** 和 **USDC** 全部的价值代币。
{% endhint %}

## CiaoTool PumpFun 创建并买入是什么？

<figure><img src="../../../.gitbook/assets/image (16).png" alt="CiaoTool Solana Chain Pump 创建代币并买入页面"><figcaption></figcaption></figure>
