---
description: >-
  Custom-built for Pump.fun and PumpSwap, this tool executes multi-wallet
  purchases within a single block, securely optimizing holder distribution and
  boosting asset allocation efficiency.
---

# Pump - Multi-Address Bundled Buy Guide

{% hint style="info" %}
**CiaoTool Pump Multi-Address Bundled Buy** now fully supports all quote tokens, including official **SOL and USDC**.&#x20;
{% endhint %}
...
Start your Multi-address Bundled Buy on PumpFun and PumpSwap with CiaoTool now:

{% embed url="https://ciaotool.io/en/pump/multi-address-buy" %}
