...
{% hint style="info" %}
**CiaoTool Pump 市值管理**现已全面支持官方 **SOL** 和 **USDC** 全部的价值代币
{% endhint %}

## 功能介绍

**CiaoTool Pump 市值管理**是一款面向 Pump.fun 与 PumpSwap 的自动化做市及流动性管理工具。用户可自定义交易金额、执行频率、钱包数量和买卖策略，由系统自动调度多个钱包持续执行交易，提升市场活跃度并优化整体数据表现。
