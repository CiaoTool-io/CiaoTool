...
# Solana - Batch Swap Guide

{% hint style="info" %}
**CiaoTool Raydium Batch Swap** now fully supports all liquidity pool types, including **AMM V4, CLMM, and CPMM**.
{% endhint %}

## Overview

**CiaoTool Solana Batch Trading** is a multi-wallet automated trading tool for Raydium. Users can import or select multiple wallets, configure the trade direction and amount for each wallet, and execute token purchases or sales in one batch.
...
{% embed url="https://ciaotool.io/en/raydium/batch-swap" %}
