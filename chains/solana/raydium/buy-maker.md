...
# Solana - Boost Makers Guide

{% hint style="info" %}
**CiaoTool Raydium Boost Makers** now fully supports all liquidity pool types, including **AMM V4, CLMM, and CPMM**.
{% endhint %}

## Overview

**CiaoTool Solana Boost Makers** is a multi-address automated trading tool for Raydium. It generates new wallets in batches and uses them to purchase a specified token.
...
{% embed url="https://ciaotool.io/en/raydium/newaddr-buyers-markers" %}
