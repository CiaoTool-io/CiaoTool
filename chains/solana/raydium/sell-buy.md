...
# Solana - Sell & Bundled Buy Guide

{% hint style="info" %}
**CiaoTool Raydium Sell & Bundled Buy Tutorial** now fully supports all liquidity pool types, including **AMM V4, CLMM, and CPMM**.
{% endhint %}

## Overview

**CiaoTool Solana Sell and Multi-Wallet Bundled Buy** is a combined trading tool for Raydium. Users can configure the selling wallet, sell amount, buying wallets, and purchase amount for each wallet. The system automatically builds a “sell first, buy next” transaction sequence and submits it as a Bundle.
...
{% embed url="https://ciaotool.io/en/raydium/sell-buy" %}
