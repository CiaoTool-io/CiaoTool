...
# Solana - Anti-MEV Volume Bot Guide

{% hint style="info" %}
**CiaoTool Raydium Anti-MEV Volume Bot** now fully supports all liquidity pool types, including **AMM V4, CLMM, and CPMM**.
{% endhint %}

## Overview

**CiaoTool Solana Anti-MEV Volume Bot** is an automated trading tool for Raydium. Users can customize trade amounts, execution frequency, and participating wallets, while the system continuously executes multi-wallet buy and sell operations to increase trading volume and on-chain activity.
...
{% embed url="https://ciaotool.io/en/raydium/anti-mev" %}
