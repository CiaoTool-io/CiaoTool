...
{% hint style="info" %}
**CiaoTool Raydium 防夹交易量机器人**现已全面支持 **AMM、CLMM、CPMM** 全部的流动性池类型，请先切换到指定池子功能页面进行机器人操作，满足不同场景下的快捷做市服务。
{% endhint %}
...
{% embed url="https://ciaotool.io/zh-CN/raydium/anti-mev" %}
...
**Raydium 防夹交易量机器人**使用私钥导入钱包没有数量限制。交易手续费由每个钱包独立支付。
{% endhint %}
