...
**CiaoTool Solana 市值管理**是一款面向 Raydium 的自动化做市及流动性管理工具。用户可自定义交易金额、执行频率、钱包数量和买卖策略，由系统自动调度多个钱包持续执行交易，提升市场活跃度并优化整体数据表现。
...
* **策略丰富：** 支持拉升、回调及交易量等多种执行模式
* **参数灵活：** 自定义金额、频率、间隔、次数和参与钱包
* **多钱包调度：** 统一管理多个地址并执行预设交易策略
* **自动化运行：** 一键启动任务，持续跟踪交易状态与执行结果
