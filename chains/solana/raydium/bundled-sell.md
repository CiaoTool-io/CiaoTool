...
# Solana - Multi-Address Bundled Sell Guide

{% hint style="info" %}
**CiaoTool Raydium Multi-address Bundled Sell** now fully supports all liquidity pool types, including **AMM V4, CLMM, and CPMM**.
{% endhint %}

## Overview

**CiaoTool Solana Multi-Wallet Bundled Sell** is a batch-selling tool for Raydium. Users can configure multiple seller wallets and token amounts, while the system automatically builds the transactions and submits them in a Bundle according to the preset order.
...
{% embed url="https://ciaotool.io/en/raydium/multi-address-sell" %}
