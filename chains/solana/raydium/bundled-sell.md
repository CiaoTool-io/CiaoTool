...
{% hint style="info" %}
**CiaoTool Raydium 多地址捆绑卖出**现已全面支持 **AMM、CLMM、CPMM** 全部的流动性池类型，请先切换到指定池子功能页面进行多地址捆绑卖出操作，满足不同场景下的快捷卖出服务。
{% endhint %}
...
{% embed url="https://ciaotool.io/zh-CN/raydium/bundled-buy" %}
...
**Raydium 多地址捆绑卖出**导入钱包没有数量限制，每组交易最多支持 20 个地址捆绑卖出。
