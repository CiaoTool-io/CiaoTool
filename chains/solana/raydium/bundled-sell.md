...
{% hint style="info" %}
**CiaoTool Raydium 多地址捆绑卖出**现已全面支持 **AMM V4、CLMM、CPMM** 全部的流动性池类型
{% endhint %}

## 功能介绍

**CiaoTool Solana 多地址捆绑卖出**是一款面向 Raydium 的多钱包批量卖出工具。用户可配置多个卖出钱包及代币数量，系统自动构建交易并通过 Bundle 按预设顺序提交。
