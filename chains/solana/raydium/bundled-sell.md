...
**CiaoTool Solana 多地址捆绑卖出**是一款面向 Raydium 的多钱包批量卖出工具。用户可配置多个卖出钱包，系统自动构建交易并通过 Bundle 按预设顺序提交。
...
* **同区块执行：** Bundle 上链后，包内交易按预设顺序连续完成
* **减少交易间隙：** 降低批量卖出期间被其他交易插入的风险
...
服务费和Jito 小费均由第一个地址支付，调整导入的第一个地址中有足够余额。
{% endhint %}
