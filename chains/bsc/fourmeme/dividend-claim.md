---
description: >-
  Batch query and claim holder rewards for Fourmeme, OpenFour, 4STOCK, Lista,
  and RWA tokens, with multi-address imports, automatic verification, grouped
  execution, and progress tracking.
---

# Fourmeme - Dividend Claim Guide

## Overview

**CiaoTool Fourmeme Dividend Claim** is a batch dividend claiming tool for BNB Chain. It supports Fourmeme Standard, OpenFour, and other compatible dividend tokens.
...
{% embed url="https://bsc.ciaotool.io/en/fourmeme/batch-claim-dividend" %}
...
* [x] Calling the Fourmeme dividend contracts
* [x] Paying BNB Gas
...
The recipient address must own the Fourmeme dividend entitlement for the selected token. The payment wallet can only pay the claiming fees and cannot change dividend ownership.
{% endstep %}
