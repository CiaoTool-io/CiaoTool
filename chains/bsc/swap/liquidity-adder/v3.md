...
If you want to add a V2 liquidity pool featuring ease of use and full-range coverage, please refer to the [**PancakeSwap V2 Liquidity Pool Adder**](v2.md) guide.
{% endhint %}
