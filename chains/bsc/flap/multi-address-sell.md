---
description: >-
  支持在 BSC 链上针对 Flap.sh 发射平台进行同区块多钱包并发平仓。纯前端本地处理私钥，彻底阻断 MEV
...
{% hint style="info" %}
**CiaoTool Flap 多地址捆绑卖出**现已全面支持官方 **BNB、USD1、UUSD、USDT**  和 **RWA** 全部的价值代币，请先切换到指定代币页面进行多地址捆绑卖出操作，满足不同场景下的快捷捆绑服务。
{% endhint %}

## CiaoTool Flap 多地址捆绑卖出？

<figure><img src="../../../.gitbook/assets/image (607).png" alt="CiaoTool BSC生态 Flap 多地址捆绑卖出 功能页面"><figcaption></figcaption></figure>

**Flap 多地址捆绑卖出** 是一种专为 Flap.sh 发射平台设计的高阶链上平仓与筹码回收策略。该功能允许通过单一指令调度先前分散建仓的多个独立子钱包，在同一个区块链区块内进行并发卖出。
...
立即在 Flap 上，用 CiaoTool​ 多地址捆绑卖出功能进行一键卖出操作：

{% embed url="https://bsc.ciaotool.io/zh-Hans/flap/bnb/multi-address-sell" %}

***

## 为什么选择 CiaoTool Flap 多地址捆绑卖出？
